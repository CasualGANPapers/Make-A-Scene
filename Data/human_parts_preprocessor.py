...
class HumanPartsPreprocessor:
    def __init__(self, weights="../../Self-Correction-Human-Parsing/checkpoints/final.pth"):
    ...
    def segment_image(self, image):
        ...
        encoded = F.one_hot(torch.from_numpy(parsing_result), num_classes=self.num_classes)
